...
namespace PDS.WITSMLstudio.Store.Data
{
    ...
    public abstract class ProdmlEtpDataProvider<TObject> : ProdmlDataProvider<TObject>
        where TObject : Prodml200.AbstractObject
    {
        /// <summary>
        ...
        protected ProdmlEtpDataProvider(IContainer container, IWitsmlDataAdapter<TObject> dataAdapter) : base(container, dataAdapter)
        {
        }
        ...
        {
            dataObject.Uuid = dataObject.NewUuid2();
