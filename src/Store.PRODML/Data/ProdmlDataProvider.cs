...
namespace PDS.WITSMLstudio.Store.Data
{
    ...
    public abstract class ProdmlDataProvider<TObject> : IEtpDataProvider<TObject>, IEtpDataProvider
    {
        /// <summary>
        ...
        protected ProdmlDataProvider(IContainer container, IWitsmlDataAdapter<TObject> dataAdapter)
        {
            Logger = LogManager.GetLogger(GetType());
            Container = container;
            DataAdapter = dataAdapter;
        }
        public  string ServerSortOrder => DataAdapter.ServerSortOrder;
        /// <summary>
        /// Gets the logger.
        /// </summary>
